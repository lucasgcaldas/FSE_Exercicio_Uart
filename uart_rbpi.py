from protocolos.ProtocoloString import ProtrocoloString
from protocolos.ProtocoloNum import ProtrocoloNum
...
if __name__ == "__main__":
    try:
        protocolo = ProtrocoloNum("0xA1", 310519, "5426")

        main(protocolo.envia)
